...
//   // 1. Temporary Blogs Data (Jo pehli baar dikhega)
//   const initialBlogs = [
//     {
//       id: 1,
...
//       content: "Realism over Minimums: FAA 40 ghante (Part 61) ka minimum bolta hai, lekin real average 70-80 hours hota hai. Sabse pehle FAA First-Class Medical certificate lena chahiye taki baad mein koi surprise na ho. Instructor sirf hour-building ke liye nahi, balki padhane ke liye dedicated hona chahiye.",
//       date: "Jan 31, 2026",
...
//       content: "Talking to ATC feels like learning a third language. 'Fun Flight 172, cleared for the option, runway 27.' It sounds fast, but it becomes second nature. Practice with a scanner or LiveATC at home. Consistency is key: Hafte mein kam se kam 3 din training zaruri hai progress maintain karne ke liye.",
//       date: "Feb 08, 2026",
//       category: "Training",
...
//   // 2. Logic: LocalStorage check karna aur Data load karna
//   useEffect(() => {
//     const savedBlogs = localStorage.getItem('funflight_blogs');
    
//     if (!savedBlogs || JSON.parse(savedBlogs).length === 0) {
//       // Agar DB khali hai, toh temporary blogs ko save karo aur dikhao
//       localStorage.setItem('funflight_blogs', JSON.stringify(initialBlogs));
//       setBlogs(initialBlogs);
//     } else {
//       // Agar blogs pehle se hain, toh unhe dikhao
//       setBlogs(JSON.parse(savedBlogs));
//     }
//   }, []);

//   // 3. Search aur Category Filter Logic
...
//             <span className="w-12 h-[1px] bg-[#c5a059] self-center"></span>
//             <span className="mx-4 text-[#c5a059] text-[10px] font-black uppercase tracking-[0.5em]">The Hangar</span>
//             <span className="w-12 h-[1px] bg-[#c5a059] self-center"></span>
//           </div>
//           <h1 className="text-6xl md:text-8xl font-black tracking-tighter uppercase text-white mb-4">
//             Aviation <span className="text-[#c5a059]">Hub</span>
//           </h1>
//           <p className="text-white/40 uppercase tracking-[0.3em] text-[10px] font-bold">
//             Insights, Stories & Pilot Wisdom from the Flight Deck
//           </p>
//         </div>
//       </div>
...
//          <p className="text-[9px] text-white/20 font-black uppercase tracking-[0.5em]">© 2026 Fun Flight Academy / Ground School Division</p>
//       </footer> */}
//     </div>
//   );
// };
